...
import com.android.mymindnotes.databinding.ActivityTraumaDiaryThoughtBinding
...
class TraumaDiaryThought : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // gif 이미지를 이미지뷰에 띄우기
        Glide.with(this).load(com.android.mymindnotes.R.drawable.diarybackground1).into(binding.recordbackground)
    ...
    private fun tipDialog() {
        val builder = AlertDialog.Builder(this)
        builder.setIcon(com.android.mymindnotes.R.drawable.tips)
        builder.setTitle("생각 작성 Tips")
        builder.setMessage(com.android.mymindnotes.R.string.traumaThoughtTips)
        builder.setPositiveButton("확인", null)
        alertDialog = builder.show()
        alertDialog.show()
    }
