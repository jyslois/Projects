...
class TodayDiaryThought : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // gif 이미지를 이미지뷰에 띄우기
        Glide.with(this).load(com.android.mymindnotes.R.drawable.diarybackground1).into(binding.background)
    ...
    private fun tipDialog() {
        ...
        builder.setMessage(com.android.mymindnotes.R.string.thoughtTips)
        builder.setPositiveButton("확인", null)
        alertDialog = builder.show()
        alertDialog.show()
    }
