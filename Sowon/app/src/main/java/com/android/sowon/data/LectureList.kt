...
class LectureList () {
    fun getLectureList(): List<Lecture> {
        return listOf(
            Lecture(
                1, "기초", R.drawable.example6, "기초 수업 초급반", "지연"
            ),
            Lecture(
                2, "기초", R.drawable.example5, "기초 수업 중급반", "지연"
            ),
            Lecture(
                3, "기초", R.drawable.example4, "기초 수업 고급반", "지연"
            ),
            Lecture(
            ...
            Lecture(
                6, "배달의 민족", R.drawable.baeminexample1, "배달의 민족 기초반", "지연"
            ),
            Lecture(
                7, "배달의 민족", R.drawable.baeminexample2, "배달의 민족 심화반", "지연"
            )
        )
    }
}
